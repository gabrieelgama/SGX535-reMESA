#!/usr/bin/env python3
"""Read-only, dependency-free ELF32 inventory for the preserved psb_dri.so.
...
OUT = ROOT / "docs/phase7/psb-dri-re/analysis"
EXPECTED_SHA256 = "74ca42991906741ee91be1bc088ae0b142fa71b6a85658c5dad0851ce50dd0d8"
KEYWORDS = re.compile(
...
def main():
    ...
    summary = {
        ...
        "address_convention": "ELF VA; observed GUI addresses use ELF VA + 0x10000; file offsets are separately recorded",
    }
