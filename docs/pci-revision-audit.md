...
The real TVZ measured PCI revision `0x06` for graphics function `8086:8108` at `0000:00:02.0` ([TVZ-001](hardware-evidence/TVZ-001/README.md)). This is a PCI revision ID, not an SGX core revision.
