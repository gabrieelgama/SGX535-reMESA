...
- `header-comparison.json`: extraction of `#define NOME constante_decimal_ou_hex[UL]*`, numerically normalized, from the SGX535 TI and EMGD headers. Macros-functions and expressions are not compared; `null` represents absence in the extracted set, not physical hardware absence.
