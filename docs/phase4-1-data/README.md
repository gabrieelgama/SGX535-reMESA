...
| Additional Intel SCH Datasheet edition | Intel 319537-003US, May 2010, 450 pages | [Mouser mirror](https://www.mouser.com/pdfDocs/82US15Wdatasheet.pdf) consulted through the web tool, §9.4.5 p.106; local download unavailable; Intel copyright | Corroborates P4-017; does not identify the SGX core revision |
